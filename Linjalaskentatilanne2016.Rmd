...
leaflet(sp_data_wgs84) %>% 
      ...
      addCircleMarkers(radius=ifelse(sp_data_wgs84$D_2016=="Var",0,4), 
                       color = ~pal4(index),
                       opacity=30,
                       popup = paste0("reitin nro:", sp_data_wgs84$Reitinno.,
                              "<br />","<a href=", urli , ">", "Linjan kartta","</a>",
   ...
   addLegend("bottomright", pal = pal4, values = ~index,
    title = "Laskentatarve 2016",
    labFormat = labelFormat(prefix = " "),
    opacity = 1
  )
      
      # Add legend
            addLegend(position = 'topleft', colors = "NA", 
                      labels = "Isot pallukat kuvaavat vapaita linjoja, \n
                      mitä tummempi pallon väri on, sitä enemmän linja kaipaa laskijaa, \n 
                      viemällä hiiren pallon päälle saat lisätietoja linjasta",
                      opacity = 0.4,
                      title = 'Linjalaskentojen varaustilanne 2016')
